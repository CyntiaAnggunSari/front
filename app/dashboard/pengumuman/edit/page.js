...
import {updatePengumuman, getDetailPengumuman,} from "@/app/actions/pengumuman";
import { useSearchParams } from "next/navigation";

export default function UpdatePengumumanPage() {
  ...
  const [formState, formAction] = useActionState(updatePengumuman, {
    status: 0,
    message: "",
  });
  ...
  const getDataPengumuman = async () => {
    try {
      ...
      const result = await getDetailPengumuman(data);
              ...
              <div className="flex flex-col w-full p-6 gap-3">
                ...
                <FormControl fullWidth>
                  ...
                  <TextField
                    ...
                    type="text"
                    inputRef={idRef}
                    defaultValue={dataPengumuman.id}
                  />
                </FormControl>
                <FormControl fullWidth>
                  ...
                  <TextField
                    ...
                    size="small"
                    type="text"
                    defaultValue={dataPengumuman.judul}
                  />
                </FormControl>
                <FormControl fullWidth>
                  ...
                  <TextField
                    ...
                    multiline
                    rows={4}
                    defaultValue={dataPengumuman.isi}
                  />
                </FormControl>
              </div>
            </CardContent>
